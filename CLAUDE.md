...
This project is indexed by GitNexus as **MACH_RE** (1077 symbols, 998 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
