...
- [ ] **T2: Thu gọn về 4 Axiom thực sự** → Giữ I (Quan hệ bản thể), II (Bất biến cấu trúc), IV (mạch cội dọc), V (Biên giới động). Chuyển III, VI, VII thành **Derived Propositions** có chứng minh tường minh. Verify: mỗi axiom còn lại không suy ra được từ 3 cái kia.
